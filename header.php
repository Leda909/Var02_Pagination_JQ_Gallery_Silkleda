...
<head>
  ...
  <meta name="description" content="Portfolio and webshop of Leda's silk paintings, which all are glaudy and harmonic handmade prudocts.">
  <meta name="keywords" content="silk art, silk painiting, handmade silk painiting, silk mandala, sewn silk, silk painting gift, handcraft, handmade gift, silk window painting,">
  ...
  <nav id="header" class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" >
    <div class="container" >
      ...
      <div class="cart-section md-auto">
          <a  class="btn btn-success btn-lg md-auto" href="#">  <!-- Start of cart -->
            <i class="fa fa-shopping-cart"></i>
          </a>            
          <a class="btn btn-success btn-lg md-auto"  href="#">  <!-- Log in -->
